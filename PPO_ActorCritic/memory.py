...
class replayMemory():
    ...
    def __init__(self, action_size, memory_size, batch_size, seed):
        ...
        self.experience = namedtuple("Experience", field_names=["state", "action", "reward", "next_state", "prob", "done"])
    ...
    def sample(self):
        ...
        return (state, action, reward, next_state, prob, done)

    def add(self, state, action, reward, next_state, prob, done):

        experience = self.experience(state, action, reward, next_state, prob, done)
