...
agent = Agent(env.observation_space.shape[0], env.action_space.n, seed=0, batch_size=32, q_size=20)

env.seed(0)

def DQN(num_episodes = 2000, max_iteration = 1000, init_epsilon = 1.0, min_epsilon = 0.05, decay = 0.999):
    '''
